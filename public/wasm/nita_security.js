/* @ts-self-types="./nita_security.d.ts" */
 ...
 * @param {string} role
 * @param {string} secret
 * @param {bigint} expires_in_secs
 * @returns {string}
 */
export function create_session_token(user_id, role, secret, expires_in_secs) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.create_session_token(ptr0, len0, ptr1, len1, ptr2, len2, expires_in_secs);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
...
export function generate_salt(length) {
    ...
    let deferred1_1;
    try {
        const ret = wasm.generate_salt(length);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {bigint}
 */
export function get_token_expiry(token) {
    const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_token_expiry(ptr0, len0);
 ...
 * @returns {string}
 */
export function get_token_role(token) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_token_role(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function get_token_user_id(token) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_token_user_id(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function hash_pin(pin, salt) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.hash_pin(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {boolean}
 */
export function is_safe_input(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.is_safe_input(ptr0, len0);
    return ret !== 0;
}
...
export function sanitize_input(input) {
    ...
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sanitize_input(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function sign_request(body, secret) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.sign_request(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {boolean}
 */
export function validate_session_token(token, secret) {
    const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.validate_session_token(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
 ...
 * @returns {boolean}
 */
export function verify_pin(pin, salt, stored_hash) {
    const ptr0 = passStringToWasm0(pin, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(salt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(stored_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.verify_pin(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret !== 0;
}
 ...
 * @returns {boolean}
 */
export function verify_signature(body, secret, signature) {
    const ptr0 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nita_security_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
